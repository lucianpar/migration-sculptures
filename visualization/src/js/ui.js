...
export class UIManager {
    constructor(sculptureManager) {
        ...
        this.elements = {
            ...
            metricVariabilityRating: document.getElementById('metric-variability-rating'),
            metricVariabilityFill: document.getElementById('metric-variability-fill'),
            metricVariabilityValue: document.getElementById('metric-variability-value'),
        };
    }
    ...
    updateMetrics(metrics) {
        ...
        if (metrics.centroid_drift) {
            ...
            this.elements.metricDriftValue.textContent = 
                typeof drift.value_km === 'number' ? `${drift.value_km.toFixed(2)} km` : '—';
        }
